...
$query = "SELECT tbltestconfig.testid,testname,testtypename,session,semester FROM tbltestconfig 
							...
							where(tblscheduling.date=curdate() and tblscheduling.dailyendtime>curtime() and tblscheduling.dailystarttime<=curtime() and tblcandidatestudent.candidateid='$candidateid')";
//exit;
