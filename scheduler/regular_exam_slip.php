...
$progid = $_SESSION['programmeadmitted'];
        ...
        <div id="slipdiv">
            ...
            <div>
                <table id="sliptb" class="table table-bordered">
                    <tr>
                        <th colspan="4" class="center"><h2>Computer Based Test/Exam Slip:-
                                              <?php
                            for ($q = 0; $q < count($sbjs); $q++) {
                                $sbjnm = get_subject_name($sbjs[$q]);
                                $sbjcd = get_subject_code($sbjs[$q]);
                                echo"$sbjnm";
                                echo"(".$sbjcd.")";
                            }
                            ?>
                    ...
                    <tr>
                        <td>Department:</td>
                        <td colspan="2"><?php echo ucwords(strtolower($dept)); ?></td>
