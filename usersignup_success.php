...
<html lang="en">
    ...
    <head>
        <title>
            <?php echo pageTitle("User Signup Success") ?>
        </title>
            ...
            <div class="span5 style-div" style="margin-left: auto; width:350px; margin-top: 70px; padding-left: 30px; margin-right: auto;">
                <div class="contentbox" style="padding-top: 10px;">
                    <div class="page-header" style="border-bottom-color: #cccccc; border-bottom-style: solid; border-bottom-width: 1px;">
                        <h2 style="font-family: 'Segoe UI',Helvetica,Arial,sans-serif; color:rgb(51, 51, 51); color:green; text-rendering: optimizelegibility; font-size: 18px; font-weight: 700; line-height:40px; ">Sign up Success!</h2>
                    </div>
                    <?php require_once('partials/notification.php'); ?> 
                    <br /><br /><br />
                    Your account was created successfully. <br /><br />Click <a href='login.php'>here to login</a>.
                    <br /><br /><br />
                </div>
            </div>
        </div>
