 ...
 */
 ...
 (function($){
	...
	$.fn.tablePagination = function(settings) {
		var defaults = {  
			firstArrow : (new Image()).src="../../assets/img/first.gif",  
			prevArrow : (new Image()).src="../../assets/img/prev.gif",
			lastArrow : (new Image()).src="../../assets/img/last.gif",
			nextArrow : (new Image()).src="../../assets/img/next.gif",
			rowsPerPage : 25,
			currPage : 1,
      ...
      function createPaginationElements() {
        ...
        htmlBuffer.push("<select id='tablePagination_rowsPerPage' style = 'width: 70px;'><option value='5'>5</option></select>");
        ...
        htmlBuffer.push("<input id='tablePagination_currPage' type='input' value='"+currPageNumber+"' size='1' style = 'width: 50px;'>");
