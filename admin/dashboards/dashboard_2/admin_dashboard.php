...
<html lang="en">
    ...
    <body>
        ...
        <div id="container" class="container">
            <h2 class="page-header">Test Administrator's Dashboard</h2>
            <ul class="nav nav-tabs smaller">
                <li class="active"><a href="">Home</a></li>
                <li><a href ="../user_2/index.php">Users</a></li>
                <li><a href ="../user_2/enabledisableuser_form.php">Enable/Disable User</a></li>
                <li><a href ="users.php">Assign Compositor Role/Permission</a></li>
                <li><a href ="invigilator.php">Assign Invigilator Role/Permission</a></li>
            </ul>
        </div>
