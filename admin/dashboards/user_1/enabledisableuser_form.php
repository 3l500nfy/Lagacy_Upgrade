...
<html lang="en">
    ...
    <body>
        ...
        <div id="container" class="container">
            ...
            <?php
            $query = "SELECT user.username, user.password, user.displayname, user.email, user.staffno, user.enabled, user.id FROM user inner join userrole on (user.id= userrole.userid) where (userrole.roleid=8 || userrole.roleid=9 || userrole.roleid=13) && user.id <> ".$_SESSION['MEMBER_USERID']." group by user.username";
