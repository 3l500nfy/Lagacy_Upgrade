...
<html lang="en">
    ...
    <body style="background-image: url('../img/bglogo2.jpg');">
        <div id="framecontent">
            ...
            [<a class="anchor current"href="view_report_summary.php?tid=<?php echo $testid; ?>">Test Result Summary</a>] | [<a class="anchor" href="view_question_summary.php?tid=<?php echo $testid; ?>">Question Response Statistics</a>] | [<a class="anchor" href="view_presentation_summary.php?tid=<?php echo $testid; ?>">Presentation Report</a>] | [<a class="anchor" href="view_report_summary_2.php?tid=<?php echo $testid; ?>">Test Result Summary Beta</a>]
            <form class="style-frm" id="test-report-frm" method="post" target="_blank" action="show_summary_print.php"><input type="hidden" name="tid" id="tid" value="<?php echo $test_config['testid']; ?>" />
                <div id="filter-panel">
