...
<html lang="en">
    ...
    <body>
       ...
       <div id="container" class="container" style="padding-left: 20px">
            ...
            <h1 style="padding-left: 20px">Change Question(s) attached to subject..</h1>
            </div>
            <div id=" " class="row">
<?php
...
?>
         ...
         <div class="span12"> 
                                ...
                                <form id="authfrm" action="index.php" method="post" enctype='multipart/form-data' class="style-frm">
                                    ...
                                    <table class="table table-bordered">
                                        <tr>
                                            ...
                                            <td>
                                                <center><input type="submit" id="load" value="Load" name="load" /></center>
                                            </td>
                                        </tr>
                                        <tr>
            ...
            <script type="text/javascript">
                ...
                $('#subjcat2').live('change',function(event){
                    $('#new_subject').html("<option value=''>loading...</option>");
                    $('#topic2').html("<option value=''>loading...</option>");
                    var sbjcat=$(this).val();
                    if(sbjcat=="")
                    {
                        $('#new_subject').html("<option value=''>--Select subject--</option>");
                        return false;
                    }
                    $.ajax({
                        type:'POST',
                        ...
                        //alert(msg);
                        $('#new_subject').html(msg);
                        $('#topic2').html("<option value=''>--Select topic--</option>");
                    });
                });
                ...
                $('#new_subject').live('change',function(event){
                    $('#topic2').html("<option value=''>loading...</option>");
                    var sbj=$(this).val();
                    if(sbj=="")
                    {
                        $('#topic2').html("<option value=''>All topics</option>");
                        return false;
                    }
                    $.ajax({
                        type:'POST',
                        ...
                        //alert(msg);
                        $('#topic2').html("<option value=''>All topics</option>"+msg);
                    });
                });
